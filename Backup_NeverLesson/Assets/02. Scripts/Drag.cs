...
{
    public static GameObject draggingItem = null; // 이 변수를 Drop 클래스에서 참조하기
    Transform itemTr;
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        // 3초 후 드래그 된 스킬을 Slot의 자식에서 ItemList의 자식으로 이동함
    ...
    IEnumerator SetParent()
    {
        ...
        itemTr.transform.SetParent(itemListTr.transform);
    }
}
